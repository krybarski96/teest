        ...
        <div className="w-full bg-white py-16 px-4">
            <div className="max-w-screen-xl mx-auto grid md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center">
                    <p className="text-second_mustard text-xl font-bold mx-auto text-center">DATA ANALYTICS DASHBOARD</p>
                    ...
                    <button className="text-second_mustard bg-black w-60 rounded-xl font-medium text-lg my-6 mx-auto py-3">Zacznijmy!</button>
                </div>
            </div>
        </div>
    )
