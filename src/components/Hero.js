...
const Hero = () => {
    return (
        ...
        <div className="text-white -mt-[5rem] bg-mountain bg-no-repeat bg-cover bg-black bg-auto bg-blend-overlay">
            <div className="max-w-screen-xl w-full h-screen pt-[96px]  mx-auto text-center flex flex-col justify-center">
                ...
                <button className=" text-black bg-main_blue w-64  rounded-xl font-medium text-lg my-6 mx-auto py-4">Zaczynamy!</button>
            </div>
        </div>
    )
}
